...
if(isset($_POST["confermaIscrizione"])){
    if ((!(empty($_POST["nomeAnimale"])) && !(empty($_POST["genereAnimale"])) && !(empty($_POST["razzaAnimale"])) && !(empty($_POST["immagineAnimale"])))){
        ...
        if ($countPresence > 0){
            ...
            $sql = "INSERT INTO $tabella VALUES (DEFAULT, '$nomeAnimale', '$genereAnimale', '$razzaAnimale','$path', $IdUtente)";
            mysqli_query($db, $sql);
            if ($tabella == "cane"){
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4></span>IdConcorso: <?= $IdConcorso ?></h4>
                </div>
