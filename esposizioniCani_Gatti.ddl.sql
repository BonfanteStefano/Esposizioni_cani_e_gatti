...
concorso(IdConcorso, descrizione, categoria, luogo, data) -- PRIMARY KEY(IdConcorso)
...
CREATE TABLE concorso(
    ...
    CHECK(categoria IN ("Animali di razza e razze non riconosciute", "Animali domestici", "cucciolate e cuccioli di gatto dai 3 ai 6 mesi", "classe Ph Premio d’Onore", "Campionato e Premior"))
);
