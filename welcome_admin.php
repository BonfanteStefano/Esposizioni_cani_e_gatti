...
if(isset($_POST["confermaConcorso"])){
    if ((!(empty($_POST["descrizioneConcorso"])) && !(empty($_POST["animaleConcorso"])) && !(empty($_POST["dataConcorso"])) && !(empty($_POST["luogoConcorso"])) && !(empty($_POST["immagineConcorso"])) && !(empty($_POST["categoriaConcorso"])))){
        ...
        $path = $image['name'];
        $sql = "INSERT INTO concorso VALUES (DEFAULT, '$descrizioneConcorso', '$animaleConcorso', '$categoriaConcorso', '$luogoConcorso', '$dataConcorso' ,'$path')";
        mysqli_query($db, $sql);
    }
}
?>
        ...
        <div class="modal fade" id="ConcorsoModal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <form role="form" method="POST" action="welcome_admin.php" enctype="multipart/form-data">
                    ...
                    <label for="descrizioneConcorso"><span class="glyphicon glyphicon-user"></span>Descrizione concorso</label>
                    <input type="text" class="form-control" id="descrizioneConcorso" name="descrizioneConcorso" placeholder="Concorso cani 2020">
                    </div>
                    <div class="form-group">
                    <label for="animaleConcorso"><span class="glyphicon glyphicon-user"></span>Concorso riservato a</label>
                    ...
                    <select class="form-select" aria-label="Default select example" id="categoriaConcorso" name="categoriaConcorso">
                        <option selected>Seleziona...</option>
                        <option value="Animali di razza e razze non riconosciute">Animali di razza e razze non riconosciute</option>
                        <option value="Animali domestici">Animali domesticitti</option>
                        <option value="cucciolate e cuccioli di gatto dai 3 ai 6 mesi">cucciolate e cuccioli di gatto dai 3 ai 6 mesi</option>
                    ...
                    <div class="form-group">
                    <label for="luogoConcorso"><span class="glyphicon glyphicon-user"></span>Luogo</label>
                    <input type="text" class="form-control" id="luogoConcorso" name="luogoConcorso" placeholder="Bovolone">
                    </div>
                    <div class="form-group">
                    <label for="dataConcorso"><span class="glyphicon glyphicon-user"></span>Data formato YYYY-MM-DD</label>
                    <input type="text" class="form-control" id="dataConcorso" name="dataConcorso" placeholder="Inserisci la data del concorso">
                    </div>
                    <div class="form-group">
                    <label><span class="glyphicon glyphicon-user"></span>Immagine concorso: </label><input type="file" id="immagineConcorso" name="immagineConcorso" />
                    </div>
